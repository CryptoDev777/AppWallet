...
const bitcoinjs = require('litecoinposjs-lib');
...
export class HDLegacyBreadwalletWallet extends HDLegacyP2PKHWallet {
  ...
  /**
   * @see https://github.com/bitcoinjs/litecoinposjs-lib/issues/584
   * @see https://github.com/bitcoinjs/litecoinposjs-lib/issues/914
   * @see https://github.com/bitcoinjs/litecoinposjs-lib/issues/997
   */
  getXpub() {
    if (this._xpub) {
